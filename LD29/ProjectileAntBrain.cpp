...
void ProjectileAntBrain::think()
{
	...
	{
		Game::p_game->addAttack(new Projectile(p_owner, BaseAttack::OwnerGroup::Computer, p_owner->getPosition(), Game::p_game->getPlayerPosition(), sf::seconds(3), "media/fire.png", p_owner->getRangedDamage()));
